...
namespace Mkh.Host.Web.Filters
{
    ...
    internal class AuditFilterAttribute : AuthorizeAttribute, IAsyncActionFilter
    {
        ...
        public AuditFilterAttribute(IAuditLogHandler logHandler, IOptionsMonitor<AuthOptions> authOptions, ICurrentAccount account, JsonHelper jsonHelper, IModuleCollection moduleCollection, ILogger<AuditFilterAttribute> logger)
        {
