...
public class RepositoryTest : BaseTest
{
    ...
    public async void DeleteTest()
    {
        ...
        Assert.Equal(@"DELETE FROM ""article""  WHERE ""Id"" > @P1 AND ""Deleted"" = false", sql, ignoreCase: true);

        sql = _articleRepository.Find(m => m.Id > 10).ToDeleteSqlNotUseParameters();
        Assert.Equal(@"DELETE FROM ""article""  WHERE ""Id"" > 10 AND ""Deleted"" = false", sql, ignoreCase: true);
    }
    ...
    public async void UpdateTest()
    {
        ...
        Assert.Equal(@"UPDATE ""Article"" SET ""Title"" = @P1,""ModifiedBy"" = @P2,""Modifier"" = @P3,""ModifiedTime"" = @P4 WHERE ""Id"" > @P5 AND ""Deleted"" = false;", sql, ignoreCase: true);
    }
    ...
    public async void SoftDeleteTest()
    {
        ...
        Assert.Equal(@"UPDATE ""Article"" SET ""Deleted"" = true,""DeletedTime"" = @P1,""DeletedBy"" = @P2,""Deleter"" = @P3 WHERE ""Id"" > @P4 AND ""Deleted"" = false", sql, ignoreCase: true);
    }
    ...
    public async void ListTest()
    {
        ...
        Assert.Equal(Select + @" WHERE ""Id"" > @P1 AND ""Deleted"" = false", sql, ignoreCase: true);

        sql = _articleRepository.Find(m => m.Id > 10).ToListSqlNotUseParameters();
        Assert.Equal(Select + @" WHERE ""Id"" > 10 AND ""Deleted"" = false", sql, ignoreCase: true);
    }
    ...
    public void FirstTest()
    {
        ...
        Assert.Equal(Select + @" WHERE ""Title"" = @P1 AND ""Deleted"" = false LIMIT 1", sql, ignoreCase: true);
    }
    ...
    public void NotContainsTest()
    {
        ...
        Assert.Equal(Select + @" WHERE ""Deleted"" = false", sql, ignoreCase: true);
    }
