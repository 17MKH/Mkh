...
namespace Data.Adapter.Sqlite.Test
{
    public class QueryableSqlBuilderTests : DbContextTests
    {
        ...
        public void ResolveSortForLengthTest()
        {
            ...
            builder.QueryBody.SetSort(exp, SortType.Asc);
            Assert.Equal(" ORDER BY LENGTH([Title]) ASC", builder.ResolveSort());
        }
        ...
        public void ResolveSortForDatetimeFormatTest()
        {
            ...
            builder.QueryBody.SetSort(exp, SortType.Asc);
            Assert.Equal(" ORDER BY STRFTIME('%Y-%m-%d',[CreatedTime]) ASC", builder.ResolveSort());
        ...
        public void ResolveSortForNewTest()
        {
            ...
            Assert.Equal(" ORDER BY LENGTH([Title]) DESC, SUBSTR([Title],3,2) DESC", builder.ResolveSort());
        }
        ...
        public void ResolveSelectTest()
        {
            ...
            Assert.Equal("[Id] AS [Id],LENGTH([Title]) AS [Len]", sql);
