...
namespace Data.Adapter.MySql.Test
{
    public class QueryableSqlBuilderTests : DbContextTests
    {
        ...
        public QueryableSqlBuilder CreateBuilder()
        {
        ...
        public void ResolveSortForLengthTest()
        {
            ...
            builder.QueryBody.SetSort(exp, SortType.Asc);
            Assert.Equal(" ORDER BY CHAR_LENGTH(`Title`) ASC", builder.ResolveSort());
        }
        ...
        public void ResolveSortForDatetimeFormatTest()
        {
            ...
            builder.QueryBody.SetSort(exp, SortType.Asc);
            Assert.Equal(" ORDER BY DATE_FORMAT(`CreatedTime`,'%Y-%m-%d') ASC", builder.ResolveSort());
        ...
        public void ResolveSortForNewTest()
        {
            ...
            Assert.Equal(" ORDER BY CHAR_LENGTH(`Title`) DESC, SUBSTR(`Title`,3,2) DESC", builder.ResolveSort());
        }
