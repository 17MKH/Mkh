...
namespace Data.Adapter.Sqlite.Test
{
    ...
    public class MultiTableQueryableSqlBuilderTests : DbContextTests
    {
        ...
        public void ResolveSortForLengthTest()
        {
            ...
            _queryBody.SetSort(exp, SortType.Asc);
            Assert.Equal(" ORDER BY LENGTH(T1.[Title]) ASC", _builder.ResolveSort());
        }
        ...
        public void ResolveSortForDatetimeFormatTest()
        {
            ...
            _queryBody.SetSort(exp, SortType.Asc);
            Assert.Equal(" ORDER BY STRFTIME('%Y-%m-%d',T1.[CreatedTime]) ASC", _builder.ResolveSort());
        }
        ...
        public void ResolveSortForNewTest1()
        {
            ...
            Assert.Equal(" ORDER BY LENGTH(T1.[Title]) DESC, SUBSTR(T2.[Name],3,2) DESC", _builder.ResolveSort());
        }
